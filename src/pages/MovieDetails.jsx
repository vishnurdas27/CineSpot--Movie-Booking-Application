...
import { PlayCircle, StarIcon, Heart } from 'lucide-react'
      ...
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <div className='flex items-center flex-wrap gap-4 mt-4'>
            ...
            <a href='#dateSelect' className='px-10 py-3 text-sm bg-blue-400 hover:bg-blue-600 transition rounded-md font-medium cursor-pointer active:scale-95'>
              Buy Tickets
            </a>
      ...
      <div className='overflow-x-auto no-scrollbar mt-8 pb-4'>
        <div className='flex items-center gap-4 w-max px-4'>
          ...
          <div className='flex justify-center mt-20'>
            <button onClick={()=> {navigate('/movies'); scrollTo(0,0)}} className='px-10 py-3 text-sm bg-blue-400 hover:bg-blue-600 transition
