      ...
      <div className='flex flex-wrap items-center justify-center gap-2'>
        {Array.from({length: count}, (_, i) => {
          ...
          return (
            ...
            className={`h-8 w-8 rounded border border-gray-400/60 cursor-pointer
            ${selectedSeats.includes(seatId) && "bg-gray-700 text-white"} `}>
                {seatId}
            </button>
          )
        })}
  ...
  return show ? (
    <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
      ...
      <div className='relative flex-1 flex flex-col items-center max-md:mt-16'>
          ...
          <h1 className='text-2xl font-semibold mb-8 text-gray-300'>Select Your Seat</h1>
          <img src={assets.screenImage} className='grayscale brightness-200' alt='screen' />
          <p className='text-gray-400 text-sm mb-6'>SCREEN SIDE</p>

          <div className='flex flex-col items-center mt-10 text-xs text-gray-300'>
            <div className='grid grid-col items-center md:grid-cols-1 gap-8 md:gap-2 mb-6'>
          ...
          bg-gray-700 hover:bg-blue-400 transition rounded-full font-medium cursor-pointer active:scale-95'>
            Proceed to Checkout
